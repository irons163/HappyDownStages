...
@property SKTexture * toll_eat_man_tree_bitmap;
@property SKTexture * toll_eat_man_tree2_bitmap;
@property SKTexture * toll_eat_man_tree3_bitmap;
...
@property NSArray* numberImageArray;
